...
"""
    ...
    if (
        "seo strategy" in prompt
        or "seo report" in prompt
        or "seo consultant" in system_prompt.lower()
        or "complete seo" in prompt
    ):

        # --------------------------------------------------
        # Extract SEO business information
        # --------------------------------------------------
        ...
        for line in user_prompt.splitlines():
            ...
            if line_clean.lower().startswith("business name:"):
            ...
            elif line_clean.lower().startswith("business type:"):
            ...
            elif line_clean.lower().startswith("website:"):
            ...
            elif line_clean.lower().startswith("target city:"):
            ...
            elif line_clean.lower().startswith("target audience:"):
            ...
            elif line_clean.lower().startswith("primary seo goal:"):
        ...
        type_clean = business_type.lower()

        if "dent" in type_clean:
        ...
        elif "real estate" in type_clean:

            primary_service = "real estate"
            service_examples = [
                "property buying",
                "property selling",
        ...
        elif "gym" in type_clean or "fitness" in type_clean:
        ...
        keyword_templates = [
            f"{primary_service} in {city}",
            f"best {primary_service} in {city}",
            f"{primary_service} near me",
            f"professional {primary_service} in {city}",
            f"affordable {primary_service} in {city}",
            f"top {primary_service} in {city}",
            f"trusted {primary_service} in {city}",
            f"{primary_service} services {city}",
            f"{primary_service} consultation {city}",
            f"{primary_service} clinic {city}",
        ]
        ...
        for i, keyword in enumerate(
            ...
            keywords.append(
                f"| {i} | {keyword} | "
                f"Local / Commercial | Bottom | High |"
            )
        ...
        for i, service in enumerate(
            ...
            blog_topics.append(
                f"| {i} | How to Choose the Right {service.title()} in {city} | "
                f"Informational | {service} {city} | "
                f"Contact {business_name} for more information |"
            )
        ...
        seo_tasks = [
            ...
            "Review H1/H2 structure",
            "Create service-page keyword map",
            "Optimize core service page",
            "Create local SEO landing-page plan",
            "Optimize Google Business Profile",
            "Build review acquisition process",
            "Check NAP consistency",
            "Identify local citation opportunities",
            "Create internal-linking structure",
            "Create first local SEO article",
            "Create second educational article",
            "Create service-focused article",
            "Review conversion CTAs",
            "Add trust signals",
            "Research local competitors",
            "Identify content gaps",
            "Identify backlink opportunities",
            "Create local partnership list",
            "Create digital PR opportunities",
            "Review Search Console opportunities",
            "Review ranking targets",
            "Improve underperforming pages",
            "Measure leads and enquiries",
            "Prepare next 90-day SEO roadmap",
        ]
        ...
        for day, task in enumerate(
            ...
            roadmap.append(
                ...
                f"Increase organic visibility | "
                f"Improve SEO performance and lead potential |"
            )
...
**Target City:** {city}  
**Target Audience:** {audience}  
**Primary SEO Goal:** {seo_goal}

The main opportunity for **{business_name}** is to build a search strategy around high-intent local searches, service-specific pages, strong trust signals and conversion-focused SEO.

This Demo Intelligence Engine does not claim to have crawled the website. Any technical or ranking recommendation below should therefore be treated as a **recommended check or action**, not as a confirmed website issue.
...
- {primary_service} near me
- best {primary_service} in {city}

### Commercial Intent

Users comparing providers before contacting a business.

### Service Intent

Users searching for specific services such as:

{", ".join(service_examples)}.

### Informational Intent

Users researching problems, treatments, services and buying decisions before becoming customers.

The strongest lead opportunity is the combination of:

**Local + Service + Commercial Intent**
...
These are recommendations to verify, not claims about the current website.
...
Target the primary service + {city}.

### Service Pages

Create dedicated pages for important services.

Recommended service themes:

{", ".join(service_examples)}

### Title Tag Structure

**Primary Service + {city} + {business_name}**

### Internal Linking

Use:

**Homepage → Service Page → Location Page → Blog → Conversion Page**

### CTAs

Use clear conversion actions such as:
...
For {business_name}, local SEO should focus on:
...
Avoid fake reviews and duplicate doorway location pages.
...
3. Complete all profile information.
4. Add accurate services.
5. Upload real business photos.
6. Publish useful posts.
7. Answer genuine customer questions.
8. Build a review acquisition process.
9. Respond professionally to reviews.
10. Keep profile information consistent with the website.
...
### Content Pillar 1 — Service Education

Explain important services and customer questions.

### Content Pillar 2 — Local Expertise

Create useful content connected to {city}.

### Content Pillar 3 — Trust

Highlight genuine reviews, credentials, team expertise and processes.

### Content Pillar 4 — Problem Solving

Answer questions customers search before contacting a provider.

### Content Pillar 5 — Conversion

Create content that naturally moves users toward calls, enquiries or bookings.

---

## 10. Blog Opportunities

| # | Topic | Intent | Primary Keyword | CTA |
|---|---|---|---|---|
{blog_text}
...
No verified competitor data was supplied.

Therefore, do not assume competitor rankings or backlinks.

Recommended competitor research:

- Compare ranking keywords
- Identify missing service pages
- Identify content gaps
- Review local visibility
- Study backlink sources
...
- Link-worthy educational resources

Focus on relevance and quality rather than purchasing large quantities of low-quality links.
...
SEO should move users through:

**Search → Website → Engagement → Enquiry → Lead → Customer**
...
- Local address/location information

---

## 15. 30-Day SEO Content & Execution Calendar

| Day | Task | Target | SEO Objective | Expected Outcome |
|---|---|---|---|---|
{roadmap_text}
...
## 17. Top 10 Priority Actions

### 1. Build the keyword map

**Why:** Establishes the search terms each page should target.

### 2. Optimize the homepage

**Why:** Creates a strong relevance and conversion foundation.

### 3. Build dedicated service pages

**Why:** Captures high-intent service searches.

### 4. Optimize Google Business Profile

**Why:** Improves local discovery potential.

### 5. Build genuine review acquisition

**Why:** Strengthens trust and local reputation.

### 6. Improve internal linking

**Why:** Helps users and search engines discover important pages.

### 7. Publish useful local content

**Why:** Builds topical and geographic relevance.

### 8. Improve conversion CTAs

**Why:** Turns organic visitors into enquiries.

### 9. Build relevant local backlinks

**Why:** Supports authority and local visibility.

### 10. Track organic leads

**Why:** SEO should ultimately be measured by business outcomes, not rankings alone.
...
Build strong **local + service + commercial intent** coverage around {city}.

### Biggest Risk

Making SEO decisions based on assumptions instead of verified website, Search Console, analytics and competitor data.

### First 3 Actions

1. Build the keyword/page map.
2. Optimize the highest-value service and local pages.
3. Strengthen Google Business Profile and genuine review acquisition.

### 30-Day Priority

Build the technical, on-page and local SEO foundation first, then use content and authority-building to expand visibility.

### 90-Day Direction

Move from foundational optimization into:

**Content Expansion → Local Authority → Backlinks → Conversion Optimization → Lead Growth**

---

### Demo Mode Notice

This SEO strategy was generated by the **Growth Radar AI Demo Intelligence Engine**.

It uses the business information supplied in the prompt and does not pretend to have live crawl, ranking, backlink or traffic data.

The production AI engine can later replace this deterministic layer when live AI/API credits are available.
"""
